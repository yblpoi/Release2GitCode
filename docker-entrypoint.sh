...
echo "Adaptive Sync Enabled: ${ADAPTIVE_SYNC_ENABLED:-true}"
echo "Adaptive Sync Max Concurrency: ${ADAPTIVE_SYNC_MAX_CONCURRENCY:-3}"
echo "Adaptive Sync Window Size: ${ADAPTIVE_SYNC_WINDOW_SIZE:-10}"
echo "Adaptive Sync High Ratio: ${ADAPTIVE_SYNC_HIGH_RATIO:-0.2}"
echo "Adaptive Sync Medium Ratio: ${ADAPTIVE_SYNC_MEDIUM_RATIO:-0.1}"
