    ...
    def log_server_boot(self) -> None:
        self._log(
            ...
            extra={
                ...
                "http_write_timeout_seconds": settings.http_write_timeout_seconds,
                "http_pool_timeout_seconds": settings.http_pool_timeout_seconds,
                "http_max_connections": settings.http_max_connections,
                "http_max_keepalive_connections": settings.http_max_keepalive_connections,
                "github_download_user_agent": settings.github_download_user_agent,
                "chunk_size": settings.chunk_size,
                "upload_attempts": settings.upload_attempts,
                "github_max_retries": settings.github_max_retries,
                "github_backoff_base_seconds": settings.github_backoff_base_seconds,
                "github_backoff_max_seconds": settings.github_backoff_max_seconds,
                "sync_concurrency": settings.sync_concurrency,
                "large_file_size_threshold_bytes": settings.large_file_size_threshold_bytes,
                "large_file_sync_concurrency": settings.large_file_sync_concurrency,
